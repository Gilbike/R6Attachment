...
export const WeaponData: WeaponDataTable = {
  ...
  1: [
    { name: "L85A2", attachment: "Muzzle Brake" },
    { name: "AR33", attachment: "Compensator" },
    { name: "G36C", attachment: "Flash Hider" },
    { name: "R4C", attachment: "Flash Hider" },
    { name: "556XI", attachment: "Compensator" },
    { name: "F2", attachment: "Muzzle Brake" },
    { name: "AUG A2", attachment: "Flash Hider" },
    { name: "552 Commando", attachment: "Extended Barrel / Suppressor" },
    { name: "G8A1", attachment: "Muzzle Brake" },
    { name: "C8-SFW", attachment: "Muzzle Brake" },
    { name: "MK17-CQB", attachment: "Extended Barrel / Suppressor" },
    { name: "Para308", attachment: "Compensator" },
    { name: "M249", attachment: "Compensator" },
    { name: "Type89", attachment: "Flash Hider" },
    { name: "C7E", attachment: "Flash Hider" },
    { name: "PDW9", attachment: "Extended Barrel / Suppressor" },
    { name: "T-95 LSW", attachment: "Extended Barrel / Suppressor" },
    { name: "LMG-E", attachment: "Flash Hider" },
    { name: "M762", attachment: "Muzzle Brake" },
    { name: "V308", attachment: "Extended Barrel / Suppressor" },
    { name: "SPEAR .308", attachment: "Flash Hider" },
    { name: "6P41", attachment: "Muzzle Brake" },
    { name: "M4", attachment: "Extended Barrel / Suppressor" },
    { name: "AK-74M", attachment: "Muzzle Brake" },
    { name: "F90", attachment: "Extended Barrel / Suppressor" },
    { name: "M249 SAW", attachment: "Muzzle Brake" },
    { name: "FMG9", attachment: "Flash Hider" },
    { name: "ARX200", attachment: "Muzzle Brake" },
    { name: "AK12", attachment: "Flash Hider" },
    { name: "SCK2000", attachment: "Muzzle Brake" },
    { name: "MP7", attachment: "Muzzle Brake" },
    { name: "POF-9", attachment: "Flash Hider" },
    { name: "MP5K", attachment: "Compensator" },
    { name: "UMP45", attachment: "Extended Barrel / Suppressor" },
    { name: "MP5", attachment: "Muzzle Brake" },
    { name: "P90", attachment: "Compensator" },
    { name: "9x19SVN", attachment: "Extended Barrel / Suppressor" },
    { name: "416C", attachment: "Flash Hider" },
    { name: "9mm C1", attachment: "Extended Barrel / Suppressor" },
    { name: "MPX", attachment: "Extended Barrel / Suppressor" },
    { name: "M12", attachment: "Extended Barrel / Suppressor" },
    { name: "Vector .45 ACP", attachment: "Compensator" },
    { name: "T5 SMG", attachment: "Compensator" },
    { name: "SCORPION EVO 3 A1", attachment: "Compensator" },
    { name: "K1A", attachment: "Compensator" },
    { name: "ALDA 5.56", attachment: "Compensator" },
    { name: "Mx4 Storm", attachment: "Muzzle Brake" },
    { name: "AUG A3", attachment: "Extended Barrel / Suppressor" },
    { name: "P10 Roni", attachment: "Extended Barrel / Suppressor" },
    { name: "Commando 9", attachment: "Extended Barrel / Suppressor" },
    { name: "UZK50GI", attachment: "Extended Barrel / Suppressor" },
    { name: "SMG11", attachment: "Muzzle Brake" },
    { name: "Bearing9", attachment: "Flash Hider" },
    { name: "SPSMG9", attachment: "Compensator" },
    { name: "C75", attachment: "Extended Barrel / Suppressor" },
  ],
...
export const Seasons = ["Y7S4 - Operation Solar Raid", "Y8S1 - Operation Commanding Force"];
